    ...
    public class PostagemRepositorioTeste
    {
        ...
        public async Task CriaTresPostagemNoSistemaRetornaTres()
        {
            ...
            await _repositorioU.NovoUsuarioAsync(
                new NovoUsuarioDTO("Thamyres Cavalcanti", "thamyres@email.com", "201121", "URLDAFOTO", TipoUsuario.NORMAL)
            );

            await _repositorioU.NovoUsuarioAsync(
                new NovoUsuarioDTO("Genilsa Cavalcanti", "genilsa@email.com", "050276", "URLDAFOTO", TipoUsuario.NORMAL)
            );
        ...
        public async Task PegarPostagensPorPesquisaRetodarCustomizada()
        {
            ...
            var postagensTeste3 = await _repositorioP.PegarPostagensPorPesquisaAsync(null, null, "thamyres@email.com");
